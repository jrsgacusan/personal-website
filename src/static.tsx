export const FB_LINK = 'https://facebook.com/jrsgacusan';
export const TWITTER_LINK = 'https://twitter.com/jeeewelryy';
export const INSTA_LINK = 'https://www.instagram.com/jueldgreat/';
export const SMARTR_LINK =
